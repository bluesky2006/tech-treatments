      ...
      <div className="relative mx-4 w-full max-w-3xl overflow-hidden rounded-3xl bg-card shadow-2xl">
        ...
        <div className="p-6">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="/contact"
              className="inline-flex items-center justify-center rounded-2xl bg-teal-500 px-4 py-2 text-sm font-semibold text-black hover:bg-teal-400"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="inline-flex items-center justify-center rounded-2xl border border-border px-4 py-2 text-sm font-semibold text-foreground hover:bg-muted"
            >
              Not now
            </button>
          </div>
